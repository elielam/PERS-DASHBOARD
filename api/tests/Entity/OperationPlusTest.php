...
class OperationPlusTest extends TestCase
{
    ...
    public function testFieldsType()
    {
        ...
        $this->assertInternalType("boolean", $operation->getisCredit(), "Operation isCredit isn't type boolean");
    ...
    public function testToArrayBasic()
    {
        ...
        $this->assertEquals($expectedOperation, $actualOperation, "Array returned by get basic Operation Plus dosn't match");
    }
